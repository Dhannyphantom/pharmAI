...
const EXTRA_NEW_RX = {
  bello: [
    { drug: "Nifedipine", dose: "10mg", route: "Oral", frequency: "Once daily", dispensed: false },
...
export function getPatientAnalysis(patient) {
  ...
  return { interactions, duplicateResults, renal, relevantReports, relevantSignal, inventoryFlags, counsellingTips, theatreRequest };
}
