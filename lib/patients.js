...
import { ABG_BY_ID } from "./acidBaseData";
...
const BILLING_BY_ID = {
  bello: [
    ...
    { date: "2026-08-14", unit: "GOPD Pharmacy", item: "Ciprofloxacin 500mg ×14", amount: 2100, status: "Overdue" },
    { date: "2026-08-14", unit: "GOPD Pharmacy", item: "Nifedipine 10mg ×30", amount: 900, status: "Overdue" },
  ...
  adekunle: [
    ...
    { date: "2026-08-14", unit: "NHIS Pharmacy", item: "Glucometer test strips", amount: 2500, status: "Paid" },
  ],
  okoye: [
...
const CHUKWU = {
  ...
  abg: ABG_BY_ID.chukwu,
};

export const PATIENTS = [...BASE_PATIENTS, CHUKWU];

// The Patient Portal (app/patient) simulates a patient who is already
// signed in — there is no patient directory/search there, unlike the
// pharmacist-facing Attend to Patient workflow. This is the demo session's
// "logged in" patient.
export const SIGNED_IN_PATIENT_PID = "PID-20140"; // Mrs. A.B

export function getSignedInPatient() {
  return getPatientByPid(SIGNED_IN_PATIENT_PID);
}
