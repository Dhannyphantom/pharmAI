...
import { PageHeader, GlowCard, FadeIn, StaggerList, SegmentedTabs, ProgressRing, BackButton, PrimaryButton, GhostButton, LiveThinking, AIErrorNote, LiveModeNote } from "@/components/ui";
  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-8">
        <BackButton label="Back to patient search" fallbackHref="/patient" />
        ...
        <GlowCard className="mb-6 border-mint/20">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-white">Welcome, {patient.name}</h1>
