...
import { PageHeader, GlowCard, AnimatedCounter, FadeIn, PrimaryButton, BackButton, LiveThinking, AIErrorNote, LiveModeNote } from "@/components/ui";
        ...
        <FadeIn delay={1.0}>
          <GlowCard className="border-mint/25" glow="glow-mint">
            <div className="flex items-center gap-2 mb-1">
              ...
              <div className="text-eyebrow !text-mint">Real-World Example — Not Illustrative</div>
            </div>
            <h3 className="text-white font-bold text-lg mb-3">Rentosertib (INS018_055) — Insilico Medicine</h3>
            <p className="text-[13.5px] text-slate-300 leading-relaxed mb-3">
              Rentosertib is a small-molecule drug for idiopathic pulmonary fibrosis (IPF) whose biological target
              (TNIK) and molecular structure were both identified using Insilico Medicine&apos;s generative AI
              platform, Pharma.AI. The program went from project start to a nominated drug candidate in roughly 18
              months, and reached Phase 1 human trials in under 30 months — around half the typical timeline for
              this stage of drug development. Phase IIa results, published in <em>Nature Medicine</em> in June 2025,
              showed a dose-dependent improvement in lung function versus placebo, and the program advanced into
              Phase III trials in July 2026.
            </p>
            <p className="text-[12.5px] text-slate-400 leading-relaxed mb-4">
              It is widely cited as the first case of a drug candidate whose target discovery, molecular design, and
              clinical validation were all AI-driven, reaching this stage of development.
            </p>
            <a
            ...
            >
              Verify — Nature Medicine, Phase IIa results (2025) <FiExternalLink size={12} />
            </a>
          </GlowCard>
        </FadeIn>
      </main>
